namespace Project_Yahiko
{
    public class Weapon : Items
    {
        ...
        public Weapon(string name, int dieSmall,int typeSmall,int dieLarge,int typeLarge,int speed,string weaponType)
        {
            Name = name;
        ...
        public Weapon(string name, int dieSmall, int typeSmall, int dieLarge, int typeLarge,int die2Hsmall, int type2Hsmall,int die2HLarge,int type2HLarge,int speed,int speed2H, string weaponType, int cost_c, int cost_s, int cost_g)
        {
            Name = name;
            NumOfDie_Small = dieSmall;
            TypeOfDie_Small = typeSmall;
        ...
        public Weapon(string name, int dieSmall, int typeSmall, int dieLarge, int typeLarge, int speed, string weaponType, int cost_c,int cost_s,int cost_g)
        {
            Name = name;
            NumOfDie_Small = dieSmall;
            TypeOfDie_Small = typeSmall;
